...
class Preview2D {
  ...
  drawGrid() {
    ...
    for (let r = 1; r <= 5; r++) {
      ...
      this.ctx.fillText(`${r}m`, this.centerX + r * this.scale + 2, this.centerY - 2);
    }
  ...
  drawAxes() {
    ...
    // Front (0°)
    this.ctx.fillText('Front (0°)', this.centerX, this.centerY - 5 * this.scale - 10);

    this.ctx.textBaseline = 'top';
    // Back (180°)
    this.ctx.fillText('Back (180°)', this.centerX, this.centerY + 5 * this.scale + 10);

    this.ctx.textAlign = 'right';
    this.ctx.textBaseline = 'middle';
    // Left (270°)
    this.ctx.fillText('Left (270°)', this.centerX - 5 * this.scale - 10, this.centerY);

    this.ctx.textAlign = 'left';
    // Right (90°)
    this.ctx.fillText('Right (90°)', this.centerX + 5 * this.scale + 10, this.centerY);
  }
  ...
  drawSpeaker(speaker) {
    ...
    const x = this.centerX + speaker.radiusMeters * this.scale * Math.sin(azRad);
    const y = this.centerY - speaker.radiusMeters * this.scale * Math.cos(azRad);
